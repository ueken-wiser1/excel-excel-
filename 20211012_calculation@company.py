...
#全部を配列で取込
        array_entire = []
        for g in range(2,lastrow_stockbook+1):
                for f in range(2,lastcolumn_stockbook):
...
#参照元のデータが'－'である株価は前日値で埋める
                if sheet01.cell(row=j,column=4).value == '－':
                        sheet01.cell(row=j,column=4).value = sheet01.cell(row=j,column=10).value
                else:
                        pass
...
#参照元のデータが'－'であるセルを0で埋める
#M高値
                if sheet01.cell(row=j,column=13).value == '－':
                        sheet01.cell(row=j,column=13).value = 0
                else:
                        pass
#N安値
                if sheet01.cell(row=j,column=14).value == '－':
                        sheet01.cell(row=j,column=14).value = 0
                else:
                        pass
#出来高
                if sheet01.cell(row=j,column=11).value == '－':
                        sheet01.cell(row=j,column=11).value = 0
                else:
                        pass
#T-VWAP
                if sheet01.cell(row=j,column=20).value  == '－':
...
#値幅の計算式入れ直し
                ...
                if sheet01.cell(row=j,column=21).value is None:
                        sheet01.cell(row=j,column=21).value = 0
                else:
                        pass
...
#                print(sheet01.cell(row=j,column=11).value)
                sheet01.cell(row=j,column=25).value = float(sheet01.cell(row=j,column=20).value) * sheet01.cell(row=j,column=11).value

#時価総額2=VWAP(T)*発行済み株式数(U)

                sheet01.cell(row=j,column=35).value = sheet01.cell(row=j,column=20).value * sheet01.cell(row=j,column=21).value
...
#                        sheet01.cell(row=j,column=26).value = str('=V')+str(j)+str('-V')+str(j-2)
                        sheet01.cell(row=j,column=26).value = sheet01.cell(row=j,column=22).value - sheet01.cell(row=j-1,column=22).value

#信用買残前週比：(W)
#もしj=2なら、sheet01...は0
#もしsheet01...の結果が0なら、その前の0でない値を入力
#                sheet01.cell(row=j,column=27).value = str('=W')+str(j)+str('-W')+str(j-2)
                if j < 3:
                        sheet01.cell(row=j,column=27).value = 0
                else:
#                        sheet01.cell(row=j,column=27).value = str('=V')+str(j)+str('-V')+str(j-2)
                        sheet01.cell(row=j,column=27).value = sheet01.cell(row=j,column=23).value - sheet01.cell(row=j-1,column=23).value

#出来高前日比：(K)
#もしj=2なら、sheet01...は0
#                sheet01.cell(row=j,column=28).value = str('=K')+str(j)+str('-K')+str(j-2)
                if j < 3:
                        sheet01.cell(row=j,column=28).value = 0
                else:
#                        print(j)
#                        print(sheet01.cell(row=j,column=11).value)
#                        print(sheet01.cell(row=j-2,column=11).value)
                        sheet01.cell(row=j,column=28).value = sheet01.cell(row=j,column=11).value - sheet01.cell(row=j-1,column=11).value

#約定回数前日比：(H)
#もしj=2なら、sheet01...は0
#                sheet01.cell(row=j,column=29).value = str('=H')+str(j)+str('-H')+str(j-2)
                if j < 3:
                        sheet01.cell(row=j,column=29).value = 0
                else:
...
#                        print(type(sheet01.cell(row=j,column=113).value))
#                        print(type(sheet01.cell(row=j,column=116).value))
#                        print(type(sheet01.cell(row=j,column=111).value))
#                        print(type(sheet01.cell(row=j,column=112).value))
#                        print(type(sheet01.cell(row=j,column=114).value))
#                        print(type(sheet01.cell(row=j,column=115).value))

                        sheet01.cell(row=j,column=118).value = (float(sheet01.cell(row=j,column=113).value) + float(sheet01.cell(row=j,column=116).value))*2/(float(sheet01.cell(row=j,column=111).value) + float(sheet01.cell(row=j,column=112).value) + float(sheet01.cell(row=j,column=114).value) + float(sheet01.cell(row=j,column=115).value))
...
#ギャップアップ、ギャップダウン、出来高急増フラグ
                # if sheet01.cell(row=j,column=10).value is None:
                #         pass
                # else:
                #         if '\xa0' in sheet01.cell(row=j,column=10).value:
                #                 sheet01.cell(row=j,column=10).value.strip()
                #         else:
                #                 pass

                if sheet01.cell(row=j-1,column=15).value is None or sheet01.cell(row=j,column=12).value is None\
                         or sheet01.cell(row=j-1,column=15).value == '－' or sheet01.cell(row=j,column=12).value == '－' \
                         or sheet01.cell(row=j-1,column=15).value == 0 or sheet01.cell(row=j-1,column=15).value == '終値':
                        pass
                else:
                        GUD_flag = (sheet01.cell(row=j,column=12).value - sheet01.cell(row=j-1,column=15).value)/sheet01.cell(row=j-1,column=15).value
                        if GUD_flag >= 0.1:
                                sheet01.cell(row=j,column=36).value = 1
                        elif GUD_flag <= -0.1:
                                sheet01.cell(row=j,column=37).value = 1
                        else:
                                pass
                if j < 3:
                        pass
                else:
                        if sheet01.cell(row=j-1,column=11).value == 0:
                                pass
                        else:
                                volumesurge = sheet01.cell(row=j,column=11).value/sheet01.cell(row=j-1,column=11).value
                                if volumesurge >= 3:
                                        sheet01.cell(row=j,column=38).value = 1
                                else:
                                        pass
...
#株価の配列を取得する
                array_kabuka = []
                for h in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=h,column=4).value is None:
                                sheet01.cell(row=h,column=4).value = 0
                        else:
                                array_kabuka.append(float(sheet01.cell(row=h,column=4).value))
#                        print(array_kabuka)
#                print(array_kabuka)
...
#                        print(idoheikin5[0])
#                        print(idoheikin5)
                        sheet01.cell(row=j,column=201).value = idoheikin5[j-2]
...
#移動平均線数値　25日＝当日〜24日前の株価総和/25
                if j < 26 :
                        ...
                        sheet01.cell(row=j,column=202).value = idoheikin25[j-2]
...
#                        sheet01.cell(row=j,column=203).value = str('=SUM(D')+str(j-75)+str(':D')+str(j)+str(')/75')
                        ...
                        sheet01.cell(row=j,column=203).value = idoheikin75[j-2]
#移動平均乖離率　5日＝（株価ー移動平均5日）/移動平均5日
                if j < 6 :
                        sheet01.cell(row=j,column=204).value = 0
                else:
                        idoheikinkairi5 = (array_kabuka[j-2]-s.rolling(5).mean())/s.rolling(5).mean()
#                        print(idoheikinkairi5[0])
                        sheet01.cell(row=j,column=204).value = idoheikinkairi5[j-2]
#                        print(j)
#                        print(idoheikinkairi5[j-2])
#                        print(i)
#                        print(array_kabuka)
...
#移動平均乖離率　25日＝（株価ー移動平均25日）/移動平均25日
                if j < 26 :
                        ...
                        idoheikinkairi25 = (array_kabuka[j-2]-s.rolling(25).mean())/s.rolling(25).mean()
                        sheet01.cell(row=j,column=205).value = idoheikinkairi25[j-2]
#移動平均乖離率　75日＝（株価ー移動平均75日）/移動平均75日
                if j < 76 :
                        sheet01.cell(row=j,column=206).value = 0
                else:
                        idoheikinkairi75 = (array_kabuka[j-2]-s.rolling(75).mean())/s.rolling(75).mean()
                        sheet01.cell(row=j,column=206).value = idoheikinkairi75[j-2]
...
#平均出来高＝平均値（average(対象列)）
                array_dekidaka =[]
                for k in range(2, lastrow_stockbook+1):
                        array_dekidaka.append(sheet01.cell(row=k,column=11).value)
#                sheet01.cell(row=j,column=251).value = str('=AVERAGE(K:K)')
                sheet01.cell(row=i,column=251).value = sum(array_dekidaka)/len(array_dekidaka)
#平均約定回数＝平均値（average(対象列)）
                array_yakujo =[]
                for k in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=k,column=8).value is None:
...
#                print(array_yakujo)
                sheet01.cell(row=i,column=252).value = sum(array_yakujo)/len(array_yakujo)
#平均回転日数＝平均値（average(対象列)）
                array_kaiten =[]
                for k in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=k,column=118).value is None:
                                sheet01.cell(row=k,column=118).value = 0
                        else:
                                pass
...
#                print(array_kaiten)
#                print(len(array_kaiten))
                sheet01.cell(row=i,column=253).value = sum(array_kaiten)/len(array_kaiten)
#平均移動平均乖離率5日＝平均値（average(対象列)）
                array_idoheikin5 =[]
                
                for k in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=k,column=204).value is None:
                                sheet01.cell(row=k,column=204).value = 0
                        else:
                                pass
#                        print(sheet01.cell(row=k,column=204).value)
...
#                print(array_idoheikin5)
                sheet01.cell(row=i,column=254).value = sum(array_idoheikin5)/len(array_idoheikin5)
#平均移動平均乖離率25日＝平均値（average(対象列)）

                array_idoheikin25 =[]
                for k in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=k,column=205).value is None:
                                sheet01.cell(row=k,column=205).value = 0
                        else:
                                pass
                        array_idoheikin25.append(float(sheet01.cell(row=k,column=205).value))
#                sheet01.cell(row=j,column=255).value = str('=AVERAGE(GW:GW)')
                sheet01.cell(row=i,column=255).value = sum(array_idoheikin25)/len(array_idoheikin25)
#平均移動平均乖離率75日＝平均値（average(対象列)）
                array_idoheikin75 =[]
                for k in range(2, lastrow_stockbook+1):
                        array_idoheikin75.append(float(sheet01.cell(row=k,column=206).value))
#                sheet01.cell(row=j,column=256).value = str('=AVERAGE(GX:GX)')
                sheet01.cell(row=i,column=256).value = sum(array_idoheikin75)/len(array_idoheikin75)
#平均信用買残＝平均値（average(対象列)）
                array_kaizan =[]
                for k in range(2, lastrow_stockbook+1):
                        if sheet01.cell(row=k,column=23).value is None:
                                sheet01.cell(row=k,column=23).value = 0
                        else:
                                pass
                        array_kaizan.append(float(sheet01.cell(row=k,column=23).value))
#                sheet01.cell(row=j,column=257).value = str('=AVERAGE(W:W)')
                sheet01.cell(row=i,column=257).value = sum(array_kaizan)/len(array_kaizan)
...
#                sheet01.cell(row=j,column=258).value = str('=AVERAGE(DG:DG)')
                sheet01.cell(row=i,column=258).value = sum(array_yushishinki)/len(array_yushishinki)
...
#                sheet01.cell(row=j,column=259).value = str('=AVERAGE(DH:DH)')
                sheet01.cell(row=i,column=259).value = sum(array_yusihensai)/len(array_yusihensai)
...
#                sheet01.cell(row=j,column=260).value = str('=AVERAGE(V:V)')
                sheet01.cell(row=i,column=260).value = sum(array_urizan)/len(array_urizan)
...
#                sheet01.cell(row=j,column=261).value = str('=AVERAGE(DJ:DJ)')
                sheet01.cell(row=i,column=261).value = sum(array_kashishinki)/len(array_kashishinki)
...
#                sheet01.cell(row=j,column=262).value = str('=AVERAGE(DK:DK)')
                sheet01.cell(row=i,column=262).value = sum(array_kashihensai)/len(array_kashihensai)
...
#                sheet01.cell(row=j,column=263).value = str('=AVERAGE(DL:DL)')
                sheet01.cell(row=i,column=263).value = sum(array_kashichoka)/len(array_kashichoka)
...
#                sheet01.cell(row=j,column=264).value = str('=AVERAGE(AB:AB)')
                sheet01.cell(row=i,column=264).value = sum(array_dekidakahenka)/len(array_dekidakahenka)
...
#                sheet01.cell(row=j,column=265).value = str('=AVERAGE(AC:AC)')
                sheet01.cell(row=i,column=265).value = sum(array_yakujohenka)/len(array_yakujohenka)
...
#                sheet01.cell(row=j,column=266).value = str('=AVERAGE(AA:AA)')
                sheet01.cell(row=i,column=266).value = sum(array_kaizanhenka)/len(array_kaizanhenka)
#平均信用売残変化率＝平均値（average(対象列)）
                array_urizanhenka =[]
                for k in range(2, lastrow_stockbook+1):
                        array_urizanhenka.append(float(sheet01.cell(row=k,column=27).value))
#                sheet01.cell(row=j,column=267).value = str('=AVERAGE(Z:Z)')
                sheet01.cell(row=i,column=267).value = sum(array_urizanhenka)/len(array_urizanhenka)
...
#                sheet01.cell(row=j,column=268).value = str('=AVERAGE(AG:AG)')
                sheet01.cell(row=i,column=268).value = sum(array_heikinyakujo)/len(array_heikinyakujo)
#以下標準偏差計算について、@が入力されている
...
#                print(data)
                std = np.std(data)
                sheet01.cell(row=i, column=269).value = std
...
#                        print(array_yakujo)
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=270).value = std
...
#                sheet01.cell(row=j,column=271).value = str('=STDEV.P(DN:DN)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=271).value = std
...
#                print(data)
#                print(std)
                sheet01.cell(row=i, column=272).value = std
...
#                sheet01.cell(row=j,column=273).value = str('=STDEV.P(GW:GW)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=273).value = std
...
#                sheet01.cell(row=j,column=274).value = str('=STDEV.P(GX:GX)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=274).value = std
...
#                sheet01.cell(row=j,column=275).value = str('=STDEV.P(W:W)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=275).value = std
...
#                sheet01.cell(row=j,column=276).value = str('=STDEV.P(DG:DG))')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=276).value = std
...
#                sheet01.cell(row=j,column=277).value = str('=STDEV.P(DH:DH)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=277).value = std
...
#                sheet01.cell(row=j,column=278).value = str('=STDEV.P(V:V)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=278).value = std
...
#                sheet01.cell(row=j,column=279).value = str('=STDEV.P(DJ:DJ)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=279).value = std
...
#                sheet01.cell(row=j,column=280).value = str('=STDEV.P(DK:DK))')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=280).value = std
...
#                sheet01.cell(row=j,column=281).value = str('=STDEV.P(DL:DL))')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=281).value = std
...
#                sheet01.cell(row=j,column=282).value = str('=STDEV.P(AB:AB)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=282).value = std
...
#                sheet01.cell(row=j,column=283).value = str('=STDEV.P(AC:AC)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=283).value = std
...
#                sheet01.cell(row=j,column=284).value = str('=STDEV.P(AA:AA)')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=284).value = std
...
#                sheet01.cell(row=j,column=285).value = str('=STDEV.P(Z:Z))')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=285).value = std
...
#                sheet01.cell(row=j,column=286).value = str('=STDEV.P(AG:AG))')
                ...
                std = np.std(data)
                sheet01.cell(row=i, column=286).value = std
...
#                print(array_dekidaka[0])
#                print(i)
#                print(lastrow_stockbook+1)

#                print(type(std_dekidaka))
                if std_dekidaka is list:
                        sheet01.cell(row=i,column=501).value = std_dekidaka[i-2]
                else:
                        pass
...
#                print(array_yakujo)
#                print(std_yakujo)
#                print(type(std_yakujo[0]))
                if all([yoso == 0.0 for yoso in array_yakujo]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=502).value = std_yakujo[i-2]
#標準化回転日数＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kaiten = standardization(array_kaiten)
                if all([yoso == 0.0 for yoso in array_kaiten]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=503).value = std_kaiten[i-2]
...
#                        print(std_idoheikin5)
                        sheet01.cell(row=i,column=504).value = std_idoheikin5[i-2]
#                print(array_idoheikin5)
#標準化移動平均乖離率25日＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                if i < 26:
                        ...
                        sheet01.cell(row=i,column=505).value = std_idoheikin25[i-2]
#標準化移動平均乖離率75日＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                if i < 76:
                        pass
                else:
                        std_idoheikin75 = standardization(array_idoheikin75)
                        sheet01.cell(row=i,column=506).value = std_idoheikin75[i-2]

#標準化信用買残＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kaizan = standardization(array_kaizan)
                if all([yoso == 0.0 for yoso in array_kaizan]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=507).value = std_kaizan[i-2]

#標準化融資新規＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_yushishinki = standardization(array_yushishinki)
                if all([yoso == 0.0 for yoso in array_yushishinki]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=508).value = std_yushishinki[i-2]

#標準化融資返済＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_yusihensai = standardization(array_yusihensai)
                if all([yoso == 0.0 for yoso in array_yusihensai]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=509).value = std_yusihensai[i-2]

#標準化信用売残＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_urizan = standardization(array_urizan)
                if all([yoso == 0.0 for yoso in array_urizan]) is True:
                        pass
                elif statistics.stdev(array_urizan) == 0:
                        pass
                else:
#                        a = statistics.stdev(array_urizan)
#                        print(i)
#                        print(a)
#                        print(array_urizan)
                        sheet01.cell(row=i,column=510).value = std_urizan[i-2]

#標準化貸株新規＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kashishinki = standardization(array_kashishinki)
                if all([yoso == 0.0 for yoso in array_kashishinki]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=511).value = std_kashishinki[i-2]

#標準化貸株返済＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kashihensai = standardization(array_kashihensai)
                if all([yoso == 0.0 for yoso in array_kashihensai]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=512).value = std_kashihensai[i-2]

#標準化貸株超過＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kashichoka = standardization(array_kashichoka)
                if all([yoso == 0.0 for yoso in array_kashichoka]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=513).value = std_kashichoka[i-2]

#標準化出来高変化率＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_dekidakahenka = standardization(array_dekidakahenka)
                if all([yoso == 0.0 for yoso in array_dekidakahenka]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=514).value = std_dekidakahenka[i-2]

#標準化約定回数変化率＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_yakujohenka = standardization(array_yakujohenka)
                if all([yoso == 0.0 for yoso in array_yakujohenka]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=515).value = std_yakujohenka[i-2]

#標準化信用買残変化率＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_kaizanhenka = standardization(array_kaizanhenka)
                if all([yoso == 0.0 for yoso in array_kaizanhenka]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=516).value = std_kaizanhenka[i-2]

#標準化信用売残変化率＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_urizanhenka = standardization(array_urizanhenka)
                if all([yoso == 0.0 for yoso in array_urizanhenka]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=517).value = std_urizanhenka[i-2]

#標準化平均約定金額＝standardize（当日の値，平均値（average(対象列)），標準偏差(stdevp(対象列)）
                std_heikinyakujo = standardization(array_heikinyakujo)
                if all([yoso == 0.0 for yoso in array_heikinyakujo]) is True:
                        pass
                else:
                        sheet01.cell(row=i,column=518).value = std_heikinyakujo[i-2]
...
#売り時/買い時スコア＝12*標準化出来高(SG)+15*標準化約定回数(SH)+6*標準化平均約定金額(SX)+3/標準化回転日数(SI)+9*標準化移動平均乖離率5日(SJ)+6*標準化信用買残(SM)+10*信用規制(CW)+8*増担規制(CX)+4*標準化融資新規(SN)+2/標準化融資返済(SO)+4/標準化信用売残(SP)+5*空売り規制(DB)+3/標準化貸株新規(SQ)+2*標準化貸株返済(SR)+1/標準化貸株超過(SS)+(20*IR)
                if sheet01.cell(row=i,column=51).value is None:
                        sheet01.cell(row=i,column=51).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=101).value is None:
                        sheet01.cell(row=i,column=101).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=102).value is None:
                        sheet01.cell(row=i,column=102).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=106).value is None:
                        sheet01.cell(row=i,column=106).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=501).value is None:
                        sheet01.cell(row=i,column=501).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=502).value is None:
                        sheet01.cell(row=i,column=502).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=504).value is None:
                        sheet01.cell(row=i,column=504).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=504).value is None:
                        sheet01.cell(row=i,column=504).value = 0
                        ...
                        pass
                if sheet01.cell(row=i,column=518).value is None:
                        sheet01.cell(row=i,column=518).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=503).value is None:
                        sheet01.cell(row=i,column=503).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=507).value is None:
                        sheet01.cell(row=i,column=507).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=508).value is None:
                        sheet01.cell(row=i,column=508).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=509).value is None:
                        sheet01.cell(row=i,column=509).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=510).value is None:
                        sheet01.cell(row=i,column=510).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=511).value is None:
                        sheet01.cell(row=i,column=511).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=512).value is None:
                        sheet01.cell(row=i,column=512).value = 0
                else:
                        pass
                if sheet01.cell(row=i,column=513).value is None:
                        sheet01.cell(row=i,column=513).value = 0
                else:
                        pass

                sheet01.cell(row=i,column=1000).value = sheet01.cell(row=i,column=501).value*12\
                         + sheet01.cell(row=i,column=502).value*15\
                                  + sheet01.cell(row=i,column=518).value*6\
                                           + 3/(1+sheet01.cell(row=i,column=503).value)\
                                                    + sheet01.cell(row=i,column=504).value*9\
                                                             + sheet01.cell(row=i,column=507).value*6\
                                                                      + sheet01.cell(row=i,column=101).value*10\
                                                                               + sheet01.cell(row=i,column=102).value*8\
                                                                                        + sheet01.cell(row=i,column=508).value*4\
                                                                                                 + 2/(1+sheet01.cell(row=i,column=509).value)\
                                                                                                          + 4/(1+sheet01.cell(row=i,column=510).value)\
                                                                                                                   + sheet01.cell(row=i,column=106).value*5\
                                                                                                                            + 3/(1+sheet01.cell(row=i,column=511).value)\
                                                                                                                                     + sheet01.cell(row=i,column=512).value*2\
                                                                                                                                              + 1/(1+sheet01.cell(row=i,column=513).value)\
                                                                                                                                                       + sheet01.cell(row=i,column=51).value*20

#                print(i)
#                print(lastrow_stockbook+1)
#                print(sheet01.cell(row=i,column=259).value)
#                print(sheet01.cell(row=i,column=260).value)
