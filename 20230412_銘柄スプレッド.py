...
for l in file_list:
    ...
    for j in range(2, sheetmarket.max_row+1):
        ...
        print(str(stock_code)+'_'+str(sheetmarket.cell(row=j,column=3).value)+'：本日終値は'+str(sheetmarket.cell(row=j,column=4).value)+'で、前日比'+str(sheetmarket.cell(row=j,column=5).value)+'でした')
