...
for l in file_list:
    ...
    for i in range(2, lastrow):
        if sheetdaily.cell(i,229).value==1 and sheetdaily.cell(i,4).value <= 1000:
            if sheetdaily.cell(i,231).value==1:
...
#出来高/出来高移動平均
            #print(sheetdaily.cell(i,11).value)
            #print(sheetdaily.cell(i,230).value)
...
#空売規制
        ...
        wb_sim.save(dirsim+daycode_format+'_'+'buy.xlsx')
